...
public class RedisUtil {
    ...
    public boolean hmset(String key, Map<String, Object> map, long time) {
        try {
            ...
            logger.error("redis hmset error：key={}, time={}", key, time, e);
            return false;
        }
    }
    ...
    public boolean hset(String key, String item, Object value, long time) {
        try {
            ...
            logger.error("redis hset error：key={}, item={}, time={}", key, item, time, e);
            return false;
        }
    }
     ...
     *
     * @param key 键
     * @return {@literal Set<Object>}
     */
    public Set<Object> sGet(String key) {
        try {
            return redisTemplate.opsForSet().members(key);
        } catch (Exception e) {
            logger.error("redis sGet error：key={}", key, e);
            return null;
        }
    }
    ...
    public boolean sHasKey(String key, Object value) {
        try {
            ...
            logger.error("redis sHasKey error：key={}", key, e);
            return false;
        }
    }
    ...
    public long sSet(String key, Object... values) {
        try {
            ...
            logger.error("redis sSet error：key={}", key, e);
            return 0;
        }
    }
    ...
    public long sSetAndTime(String key, long time, Object... values) {
        try {
            ...
            logger.error("redis sSetAndTime error：key={}, time={}", key, time, e);
            return 0;
        }
    }
    ...
    public long setRemove(String key, Object... values) {
        try {
            ...
            logger.error("redis setRemove error：key={}", key, e);
            return 0;
        }
    }
    ...
    public boolean lSet(String key, Object value) {
        try {
            ...
            logger.error("redis lSet error：key={}", key, e);
            return false;
        }
    }
    ...
    public boolean lSet(String key, Object value, long time) {
        try {
            ...
            logger.error("redis lSet error：key={}, time={}", key, time, e);
            return false;
        }
    }
    ...
    public boolean lUpdateIndex(String key, long index, Object value) {
        try {
            ...
            logger.error("redis lUpdateIndex error：key={}, index={}", key, index, e);
            return false;
        }
    }
    ...
    public long lRemove(String key, long count, Object value) {
        try {
            ...
            logger.error("redis lRemove error：key={}, count={}", key, count, e);
            return 0;
        }
    }
