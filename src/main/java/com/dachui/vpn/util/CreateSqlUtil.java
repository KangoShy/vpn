...
public class CreateSqlUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CreateSqlUtil.class);

    public static void main(String[] args) {
        //实体类所在的package在磁盘上的绝对路径
        String packageName = "F:\\FK_APP\\vpn\\src\\main\\java\\com\\dachui\\vpn\\model\\po\\";
        //生成sql的文件夹
        String filePath = "C:\\Users\\YS credit\\Desktop\\";
        //项目中实体类的路径
        String prefix = "com.dachui.vpn.model.po.";
        String className = "";
